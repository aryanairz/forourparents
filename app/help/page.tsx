...
const faqs: { q: Tri; a: Tri }[] = [
  {
    q: tri(
      ...
      "Ano ang pagsusulit sa civics ng U.S.?"
    ),
    a: tri(
      ...
      "Sa panayam sa naturalization, ang mga opisyal ng USCIS ay nagtatanong ng hanggang 10 tanong mula sa listahan ng 128 na tanong sa civics. Kailangan mong sagutin nang tama ang hindi bababa sa 6 upang makapasa."
    ),
  },
  {
    q: tri(
    ...
    a: tri(
      ...
      "Oo! Ang For Our Parents ay ganap na libre. Ang aming misyon ay tulungan ang mga pamilya na maghanda para sa pagsusulit sa civics nang walang bayad."
    ),
  },
  {
    q: tri(
      ...
      "Ilan ang tanong sa totoong pagsusulit?"
    ),
    a: tri(
      ...
      "Ang opisyal ng USCIS ay magtatanong sa iyo ng hanggang 10 tanong sa civics mula sa opisyal na listahan ng 128. Kailangan mong makuha ang 6 sa 10 na tama upang makapasa sa bahagi ng civics."
    ),
  },
  {
    q: tri(
      ...
      "Maaari ba akong mag-aral sa ibang wika?"
    ),
    a: tri(
      ...
      "Oo! Gamitin ang dropdown ng wika sa header upang lumipat sa pagitan ng English, Malayalam, Gujarati, Vietnamese, at Tagalog. Lahat ng tanong, sagot, at paliwanag ay makukuha sa lahat ng wika."
    ),
  },
  {
    q: tri(
      ...
      "Anong mga paksa ang saklaw ng pagsusulit sa civics?"
    ),
    a: tri(
      ...
      "Ang pagsusulit ay sumasaklaw sa apat na pangunahing larangan: Pamahalaan ng Amerika (kung paano ito gumagana), Mga Karapatan at Responsibilidad, Kasaysayan ng Amerika, at mga Simbolo at Pista Opisyal ng U.S."
    ),
  },
  {
    q: tri(
    ...
    a: tri(
      ...
      "Maaari kang mag-practice nang walang account, ngunit ang paggawa ng isa (libre) ay nagbibigay-daan sa iyo na subaybayan ang iyong progreso, suriin ang mga pagkakamali, at makakuha ng mga personalisadong tanong tungkol sa iyong mga kinatawan sa kongreso."
    ),
  },
];
...
const troubleshooting: { issue: Tri; fix: Tri }[] = [
  {
    issue: tri("I can't log in", "എനിക്ക് ലോഗിൻ ചെയ്യാൻ കഴിയുന്നില്ല", "હું લોગ ઇન કરી શકતો નથી", "Tôi không thể đăng nhập", "Hindi ako maka-log in"),
    fix: tri(
      ...
      "Siguraduhing tama ang email address na ginamit mo sa pag-sign up at ang 4-digit PIN na pinili mo. Kung nakalimutan mo ang iyong PIN, mag-email sa amin sa contact.forourparents@gmail.com at tutulungan ka naming makabalik."
    ),
  },
  {
    issue: tri("The app is not loading", "ആപ്പ് ലോഡ് ആകുന്നില്ല", "એપ લોડ થતી નથી", "Ứng dụng không tải được", "Hindi naglo-load ang app"),
    fix: tri(
      ...
      "Subukang i-refresh ang page o i-clear ang cache ng browser. Siguraduhing mayroon kang stable na koneksyon sa internet. Pinakamahusay na gumagana ang app sa Chrome, Safari, o Edge."
    ),
  },
  {
    issue: tri("Audio is not playing", "ഓഡിയോ പ്ലേ ആകുന്നില്ല", "ઓડિયો ચાલતું નથી", "Âm thanh không phát", "Hindi nagpe-play ang audio"),
    fix: tri(
      ...
      "Siguraduhing naka-on ang volume ng iyong device at hindi naka-silent mode. Ang read-aloud feature ay gumagamit ng text-to-speech engine ng iyong browser. Ang ilang lumang browser ay maaaring hindi sumusuporta sa lahat ng wika para sa text-to-speech."
    ),
  },
  {
    issue: tri(
      ...
      "Hindi nase-save ang aking progreso"
    ),
    fix: tri(
      ...
      "Ang progreso ay nase-save sa iyong account. Siguraduhing naka-log in ka bago magsimula ng quiz. Kung gumagamit ka ng private/incognito window, maaaring hindi ma-save ang iyong local session."
    ),
  },
];
    ...
    >
      ...
      <motion.div variants={fadeUp} className="flex items-center justify-between mb-2">
        ...
        <h1 className="text-[1.25rem] font-bold text-text-heading font-serif">
          {l("Help & Support", "സഹായവും പിന്തുണയും", "સહાય અને સમર્થન", "Trợ giúp & Hỗ trợ", "Tulong at Suporta")}
        </h1>
      </motion.div>
      ...
      <motion.section variants={fadeUp} className="bg-primary-light rounded-card p-5 sm:p-6 border border-primary">
        <h2 className="text-[1.0625rem] font-bold text-primary font-serif flex items-center gap-2 mb-3">
          ...
          {l("Our Mission", "ഞങ്ങളുടെ ദൗത്യം", "અમારું લક્ષ્ય", "Sứ mệnh của chúng tôi", "Ang Aming Misyon")}
        </h2>
        <p className="text-[1rem] text-text-body leading-relaxed">
          {l(
            ...
            "Ang 'For Our Parents' ay ginawa ng mga anak ng mga imigrante — upang tulungan ang mga magulang at matatanda na maghanda para sa pagsusulit sa naturalization ng U.S. Alam namin kung gaano ka-stressful ang prosesong ito — lalo na kapag walang mga materyales sa pag-aaral sa iyong wika. Ang app na ito ay nagbibigay ng lahat ng 128 opisyal na tanong sa civics ng USCIS sa English, Malayalam, Gujarati, Vietnamese, at Tagalog — na may mga practice mode, suporta sa audio, at mga personalisadong tanong batay sa iyong congressional district. Ito ay ganap na libre, at palaging magiging ganoon."
          )}
        </p>
      </motion.section>
      ...
      <motion.section variants={fadeUp} className="space-y-3">
        <h2 className="text-[1.0625rem] font-bold text-text-body flex items-center gap-2">
          ...
          {l("How to Use This App", "ഈ ആപ്പ് എങ്ങനെ ഉപയോഗിക്കാം", "આ એપ કેવી રીતે વાપરવી", "Cách sử dụng ứng dụng này", "Paano Gamitin ang App na Ito")}
        </h2>

        <div className="space-y-3">
          <Accordion
            title={l("1. Create an Account", "1. ഒരു അക്കൗണ്ട് ഉണ്ടാക്കുക", "1. ખાતું બનાવો", "1. Tạo tài khoản", "1. Gumawa ng Account")}
            defaultOpen
          >
            <p className="text-[0.9375rem] text-text-body leading-relaxed">
              {l(
                ...
                "I-tap ang \"Log In / Sign Up\" sa home page, pagkatapos piliin ang \"Gumawa ng Account.\" Ilagay ang iyong pangalan, apelyido, email, numero ng telepono, at pumili ng 4-digit PIN. Pipiliin mo rin ang iyong estado at congressional district para makapagtanong ang app ng mga personalisadong tanong tungkol sa iyong mga kinatawan."
              )}
            </p>
          </Accordion>
          ...
          >
            <p className="text-gray-600 leading-relaxed">
              {l(
                ...
                "Ang Practice Mode ay nagbibigay-daan sa iyo na mag-aral ng mga tanong sa sarili mong bilis. Maaari kang pumili ng partikular na paksa (Pamahalaan, Karapatan, Kasaysayan, o Simbolo at Pista Opisyal) o pag-aralan ang lahat ng paksa nang sabay. Pagkatapos sumagot, makikita mo kung tama ka at isang detalyadong paliwanag. Gamitin ang 🔊 button para marinig ang mga tanong na binabasa nang malakas."
              )}
            </p>
          </Accordion>
          ...
          <Accordion
            title={l(
              ...
              "3. Quiz Mode (Subukan ang Sarili)"
            )}
          >
            <p className="text-gray-600 leading-relaxed">
              {l(
                ...
                "Ang Quiz Mode ay ginagaya ang totoong pagsusulit sa civics. Makakakuha ka ng mga multiple-choice na tanong at makikita mo ang iyong score sa dulo. Magandang paraan ito para subukan ang sarili kapag nakapag-aral ka na. Ang mga resulta ay nase-save para masubaybayan mo ang iyong pag-unlad."
              )}
            </p>
          </Accordion>
          ...
          >
            <p className="text-gray-600 leading-relaxed">
              {l(
                ...
                "Ang feature na Suriin ang mga Pagkakamali ay nagpapakita ng mga tanong na nagkamali ka dati. Isa ito sa pinaka-epektibong paraan ng pag-aaral — mag-focus sa hindi mo pa alam. Patuloy na suriin hanggang masagot mo nang tama ang lahat!"
              )}
            </p>
          </Accordion>
          ...
          <Accordion
            title={l(
              ...
              "5. Dashboard (Iyong mga Istatistika)"
            )}
          >
            <p className="text-gray-600 leading-relaxed">
              {l(
                ...
                "Pagkatapos mag-log in, ipinapakita ng iyong Dashboard ang iyong kabuuang katumpakan, bilang ng mga tanong na sinubukan, at kung aling mga paksa ang nangangailangan ng mas maraming pagsasanay. Gamitin ito upang gabayan ang iyong mga sesyon ng pag-aaral."
              )}
            </p>
          </Accordion>
        </div>
      ...
      <motion.section variants={fadeUp} className="space-y-3">
        <h2 className="text-[1.0625rem] font-bold text-text-body flex items-center gap-2">
          ...
          {l("Frequently Asked Questions", "പതിവ് ചോദ്യങ്ങൾ", "વારંવાર પૂછાતા પ્રશ્નો", "Câu hỏi thường gặp", "Mga Madalas Itanong")}
        </h2>
      ...
      <motion.section variants={fadeUp} className="space-y-4">
        <h2 className="text-[1.0625rem] font-bold text-text-body flex items-center gap-2">
          ...
          {l("About the Naturalization Process", "നാച്ചുറലൈസേഷൻ പ്രക്രിയയെ കുറിച്ച്", "નેચરલાઇઝેશન પ્રક્રિ૯ા વિશે", "Về quy trình nhập tịch", "Tungkol sa Proseso ng Naturalization")}
        </h2>
        <div className="bg-white rounded-card border border-border p-5 sm:p-6 space-y-4">
          <div>
            <h3 className="font-semibold text-text-body mb-1">
              {l("Eligibility", "യോഗ്യത", "યોગ્યતા", "Điều kiện đủ tư cách", "Kwalipikasyon")}
            </h3>
            <p className="text-[0.9375rem] text-text-secondary leading-relaxed">
              {l(
                ...
                "Dapat ay hindi bababa sa 18 taong gulang ka, isang legal na permanenteng residente (may green card) sa loob ng hindi bababa sa 5 taon (o 3 taon kung kasal sa isang mamamayan ng U.S.), may tuloy-tuloy na paninirahan at pisikal na presensya sa U.S., at magpakita ng mabuting asal."
              )}
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-text-body mb-1">
              {l("The Interview", "ഇന്റർവ്യൂ", "ઇન્ટરવ્યૂ", "Buổi phỏng vấn", "Ang Panayam")}
            </h3>
            <p className="text-[0.9375rem] text-text-secondary leading-relaxed">
              {l(
                ...
                "Ang iyong panayam sa naturalization ay may kasamang pagsusulit sa English (pagbasa, pagsulat, at pagsasalita) at pagsusulit sa civics. Ang opisyal ng USCIS ay magtatanong ng hanggang 10 tanong sa civics at kailangan mong sagutin nang tama ang hindi bababa sa 6. Ang panayam ay isinasagawa sa English."
              )}
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-text-body mb-1">
              {l("Test Day Tips", "ടെസ്റ്റ് ദിവസ നുറുങ്ങുകൾ", "ટેસ્ટ દિવસની ટિપ્સ", "Mẻ o ngày thi", "Mga Tip sa Araw ng Pagsusulit")}
            </h3>
            <ul className="text-[0.9375rem] text-text-secondary leading-relaxed space-y-1 list-disc list-inside">
              <li>
                {l(
                  ...
                  "Dalhin ang iyong green card, state-issued ID, at appointment notice"
                )}
              </li>
              <li>
                {l(
                  ...
                  "Đến sớm 30 phút",
                  "Dumating nang 30 minuto nang maaga"
                )}
              </li>
              <li>
                {l(
                  ...
                  "Manatiling kalmado — naghanda ka nang mabuti!"
                )}
              </li>
              <li>
                {l(
                  ...
                  "Kung hindi ka pumasa, maaari kang mag-retake ng pagsusulit sa loob ng 60-90 araw"
                )}
              </li>
            </ul>
          </div>
          <div className="pt-2">
            ...
            >
              {l("Official USCIS Study Materials", "ഔദ്യോഗിക USCIS പഠന സാമഗ്രികൾ", "સત્તાવાર USCIS અભ્યાસ સામગ્રી", "Tài liệu học tập USCIS chính thức", "Opisyal na Mga Materyales sa Pag-aaral ng USCIS")}
            </a>
          </div>
        </div>
      </motion.section>
      ...
      <motion.section variants={fadeUp} className="space-y-3">
        <h2 className="text-[1.0625rem] font-bold text-text-body flex items-center gap-2">
          ...
          {l("Troubleshooting", "ട്രബിള്‍ഷൂട്ടിംഗ്", "સમસ્યા નિવારણ", "Khắc phục sự cố", "Pag-troubleshoot")}
        </h2>
        <div className="space-y-2">
      ...
      <motion.section variants={fadeUp} className="bg-white rounded-card border border-border p-5 sm:p-6 text-center space-y-4 shadow-card">
        <h2 className="text-[1.0625rem] font-bold text-text-body flex items-center justify-center gap-2">
          ...
          {l("Contact & Feedback", "ബന്ധപ്പെടുക & ഫീഡ്ബാക്ക്", "સંપર્ક અને પ્રતિસાદ", "Liên hệ & Phản hồi", "Makipag-ugnayan at Feedback")}
        </h2>
        <p className="text-[1rem] text-text-secondary leading-relaxed max-w-xl mx-auto">
          {l(
            ...
            "May tanong, kailangan ng tulong sa password o PIN, nakakita ng bug, o gustong magmungkahi ng feature? Mag-email sa amin at sasagutin ka namin."
          )}
        </p>
        <a
