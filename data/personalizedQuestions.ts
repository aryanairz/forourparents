...
export function getPersonalizedQuestions(
  ...
  questions.push({
    ...
    question: {
      ...
      tl: `Sino ang Gobernador ng ${state.name}?`,
    },
    ...
    explanation: {
      ...
      tl: `Si ${state.governor} ang kasalukuyang Gobernador ng ${state.name}.`,
    },
  });
  ...
  for (let si = 0; si < 2; si++) {
    ...
    questions.push({
      ...
      question: {
        ...
        tl: `Sino ang isa sa mga U.S. Senator ng iyong estado? (${state.name})`,
      },
      ...
      explanation: {
        ...
        tl: `Sina ${state.senators[0]} at ${state.senators[1]} ang mga U.S. Senator mula sa ${state.name}.`,
      },
    });
  }
  ...
  if (district !== undefined && state.districts[district]) {
    ...
    questions.push({
      ...
      question: {
        ...
        tl: `Sino ang iyong U.S. Representative? (${state.name}, ${districtLabel})`,
      },
      ...
      explanation: {
        ...
        tl: `Si ${rep} ang U.S. Representative para sa ${state.name} ${districtLabel}.`,
      },
    });
  }
  ...
  questions.push({
    ...
    question: {
      ...
      tl: `Ano ang kabisera ng ${state.name}?`,
    },
    ...
    explanation: {
      ...
      tl: `Ang ${state.capital} ay ang kabisera ng ${state.name}.`,
    },
  });
...
function pickWrongAnswers(correct: string, pool: string[], count: number): BilingualText[] {
  ...
  return shuffled.slice(0, count).map((name) => ({ en: name, ml: name, gu: name, vi: name, tl: name }));
}
...
function buildGovernorOptions(correct: string, _stateCode: string): BilingualText[] {
  ...
  return [{ en: correct, ml: correct, gu: correct, vi: correct, tl: correct }, ...wrongs];
}
