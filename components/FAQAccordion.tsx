...
const tri = (en: string, ml: string, gu: string, vi: string): MultiText => ({ en, ml, gu, vi });
...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    a: tri(
      "We support English, Malayalam, Gujarati, and Vietnamese. Questions, answer choices, and explanations are available in all four languages.",
      "ഇംഗ്ലീഷ്, മലയാളം, ഗുജറാത്തി, വിയറ്റ്നാമീസ് ഭാഷകൾ പിന്തുണയ്ക്കുന്നു. ചോദ്യങ്ങളും ഉത്തര തിരഞ്ഞെടുപ്പുകളും വിശദീകരണങ്ങളും നാലു ഭാഷകളിലും ലഭ്യമാണ്.",
      "અમે અંગ્રેજી, મલયાલમ, ગુજરાતી અને વિયેતનામી ભાષાઓને સપોર્ટ કરીએ છીએ. પ્રશ્નો, જવાબ વિકલ્પો અને સમજણ ચારેય ભાષાઓમાં ઉપલબ્ધ છે.",
      "Chúng tôi hỗ trợ tiếng Anh, Malayalam, Gujarati và tiếng Việt. Câu hỏi, lựa chọn đáp án và phần giải thích đều có đủ bằng cả bốn ngôn ngữ.",
    ),
  },
  {
    q: tri(
